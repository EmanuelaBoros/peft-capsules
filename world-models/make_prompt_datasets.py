...
ENTITY_PROMPTS = {
    ...
    "pers_hipe": hipe.HISTORICAL_PROMPTS,
    # space
...
DATASET_FUNCTIONS = {
    ...
    "pers_hipe": hipe.make_hipe_figure_prompt_dataset,
...
def make_and_save_tokenized_datasets(
    ...
    for short_prompt, full_prompt in prompt_dict.items():
        dataset = ds_make_fn(short_prompt, full_prompt, tokenizer, entity_data)

        save_path = common.prompt_data_path(entity_type, short_prompt, model_family)
...
def load_tokenizer(model_name):
    if "Llama-2" in model_name:
        ...
        tokenizer = AutoTokenizer.from_pretrained(
            "mistralai/Mistral-7B-v0.1", add_eos_token=True
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_family", type=str, default="Mistral")
    parser.add_argument("--entity_type", type=str, default="pers_hipe")
    # default="all")
