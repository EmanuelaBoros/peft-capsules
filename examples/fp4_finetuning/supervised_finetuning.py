...
def run_training(args, train_data, val_data):
    ...
    # Load the model, you don’t need to manually specify device_map for automatic handling
    model = AutoModelForCausalLM.from_pretrained(args.model_path, load_in_8bit=True)
    ...
    torch.distributed.init_process_group(backend="nccl")  # 'nccl' is recommended for GPU-based training

    # Assuming model and tokenizer are already defined and compatible with DDP
